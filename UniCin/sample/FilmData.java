...
public class FilmData {
    ...
    public FilmData() {
        ...
        films.add(new Film("Star Trek : First Contact", "PG-13", 2.50, "111 minutes",
                ...
                "The Borg travel back in time intent on preventing Earth's first contact with an alien species." +
                        " Captain Picard and his crew pursue them to ensure that Zefram Cochran makes his maiden" +
        ...
        films.add(new Film("How to Train Your Dragon", "PG", 3.50, "98 minutes",
                ...
                "A hapless young Viking who aspires to hunt dragons becomes the unlikely friend of a young " +
                        "dragon himself, and learns there may be more to the creatures than he assumed."));
        ...
        films.add(new Film ("Star Wars: The Return of the Jedi", "PG", 2.00, "131 minutes",
                ...
                "After a daring mission to rescue Han Solo from Jabba the Hutt, the rebels dispatch to Endor" +
                        " to destroy a more powerful Death Star. Meanwhile, Luke struggles to help Darth Vader back " +
                        "from the dark side without falling into the Emperor's trap."));
